@if (backpack_auth()->check())
    ...
    <div class="{{ config('backpack.base.sidebar_class') }}">
        ...
        {{-- /.sidebar --}}
        <div class="bg-white rounded mx-auto mb-3 p-0">
            <div class="mx-auto text-center" style="width: 140px;">
                <img src="{{ asset('img/xero_icon.png') }}" style="width: 100px;background-color:white;margin:0 auto;margin-top:5px;">
                <img src="{{ asset('img/pipedrive_icon.jpg') }}" style="width: 100px;background-color:white;margin:0 auto;">
            </div>
            <p class="" style="color: black;font-size: 12px;text-align: center;padding-bottom:10px;margin-bottom:0px;">Status:<br><span class="text-success" style="font-weight: bold;">CONNECTED</span></p>
        </div>
